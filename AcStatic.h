 struct SPageFileStatic{
    ...
    wchar_t acVersion[15];          // Asseto Corsa version
    ...
    float maxTorque;                // Not shown in ACC
    float maxPower;                 // Not shown in ACC
    int maxRpm;                     // Maximum rpm
    float maxFuel;                  // Maximum fuel tank capacity
    float suspensionMaxTravel[4];   // Not shown in ACC
    float tyreRadius[4];            // Not shown in ACC
    float maxTurboBoost;            // Maximum turbo boost
    float deprecated_1;             // Deprecated field
    float deprecated_2;             // Deprecated field
    ...
    wchar_t trackConfiguration;     // Not used in ACC
